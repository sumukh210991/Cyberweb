...
#        return image
    ...
    def checkIfImagePresent(self, filename, filePath):
        ...
        command = '/home/sumukh/env/bin/python ' + filePath + '/' + filename + ' ' + complete_filepath
    ...
    def createBathymetryPlot(self, filename, replot='false', params={}):
        ...
        if(feedback['error'] != 'true' and (feedback['result'] == "false" or feedback['plotNew'] == "true")):
            ...
            try:
                ...
                session.save()
                return e
                #return log.debug("Resource_id : %d", resource_id)
            ...
            command = 'cd ' + submitfn + ';\n/home/sumukh/env/bin/python ' + script_file + ' ' + bathymetry_file + ' ' + bathymetry_file_prbsz + ' ' + plotFileName
